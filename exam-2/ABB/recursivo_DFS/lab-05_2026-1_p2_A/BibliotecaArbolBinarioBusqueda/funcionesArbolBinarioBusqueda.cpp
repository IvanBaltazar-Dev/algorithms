    ...
    if(esNodoVacio(raiz))
        ...
        if(raiz->elemento.palabra > elemento.palabra)
            ...
            if(raiz->elemento.palabra < elemento.palabra){
                ...
                // cout << "El elemento \"" << raiz->elemento.palabra << "\". Ya se encuentra en el arbol" << endl;
                // cout << "Palabra " << raiz->elemento.palabra << "cantidad ANTES: " << raiz->elemento.cantidad << endl;
                raiz->elemento.cantidad++;
                // cout << "Palabra " << raiz->elemento.palabra << "cantidad DESPUES: " << raiz->elemento.cantidad << endl;
            }
}
...
void imprimirNodo(struct NodoArbolBinarioBusqueda *raiz) {
    cout << "          "<<left<<setw(10) << raiz->elemento.palabra << " | "<<raiz->elemento.cantidad << endl;
}
